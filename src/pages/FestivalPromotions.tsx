            ...
            <div className="min-h-screen">
                ...
                <div className="container mx-auto py-12">
                    <div className="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg mb-2">
                        <h1 className="text-3xl font-semibold mb-6 text-center">Promotion 1</h1>
                    ...
                    <div className="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg mb-2">
                        <h1 className="text-3xl font-semibold mb-6 text-center">Promotion 2</h1>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-center justify-center md:justify-end">
                                <img
                                    src="https://via.placeholder.com/400x300"
                    ...
                    <div className="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg mb-2">
                        <h1 className="text-3xl font-semibold mb-6 text-center">Promotion 3</h1>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex items-center justify-center md:justify-end">
                                <img
                                    src="https://via.placeholder.com/400x300"
...
export default FestivalPromotions;
