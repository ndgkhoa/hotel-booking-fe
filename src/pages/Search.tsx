...
const Search = () => {
    ...
    const searchParams = {
        ...
        page: page.toString(),
        minStarRating: selectedStars,
        categories: selectedHotelCategories,
    ...
    const handleHotelCategoryChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const hotelCategory = e.target.value;
        setSelectedHotelCategories(prevCategories =>
            e.target.checked ? [...prevCategories, hotelCategory] : prevCategories.filter(cate => cate !== hotelCategory)
        );
    };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            <div className="rounded-lg border border-slate-300 p-5 h-fit-sticky top-10">
                <div className="space-y-5">
                    ...
                    <HotelTypesFilter selectedHotelCategories={selectedHotelCategories} onChange={handleHotelCategoryChange} />
            ...
            <div className="flex flex-col gap-5">
                ...
                {hotelData?.data.map(hotel => <SearchResultCard key={hotel._id} data={hotel} />)}
                <Pagination
